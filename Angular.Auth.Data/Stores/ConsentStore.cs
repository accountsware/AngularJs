...
namespace Angular.Auth.Data.Stores
{
    public class ConsentStore : IConsentStore
    {
        ...
        public async Task<Angular.AuthInfrastructure.Models.Consent> LoadAsync(string subject, string client)
        {
            ...
            var result = new Angular.AuthInfrastructure.Models.Consent
            {
        ...
        public async Task UpdateAsync(Angular.AuthInfrastructure.Models.Consent consent)
        {
        ...
        public async Task<IEnumerable<Angular.AuthInfrastructure.Models.Consent>> LoadAllAsync(string subject)
        {
            var found = await context.Consents.Where(x => x.Subject == subject).ToArrayAsync();

            var results = found.Select(x => new Angular.AuthInfrastructure.Models.Consent
            {
                Subject = x.Subject, 
                ClientId = x.ClientId, 
