...
namespace Angular.Auth.Data.Stores
{
    public class ClientStore : IClientStore
    {
        ...
        public async Task<Angular.AuthInfrastructure.Models.Client> FindClientByIdAsync(string clientId)
        {
            ...
            Angular.AuthInfrastructure.Models.Client model = client.ToModel();
            return model;    
        }
    }
}
