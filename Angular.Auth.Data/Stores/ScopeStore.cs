...
namespace Angular.Auth.Data.Stores
{
    public class ScopeStore : IScopeStore
    {
        ...
        public async Task<IEnumerable<Angular.AuthInfrastructure.Models.Scope>> FindScopesAsync(IEnumerable<string> scopeNames)
        {
            var scopes =
        ...
        public async Task<IEnumerable<Angular.AuthInfrastructure.Models.Scope>> GetScopesAsync(bool publicOnly = true)
        {
            var scopes =
                from s in context.Scopes.Include("ScopeClaims")
                select s;
